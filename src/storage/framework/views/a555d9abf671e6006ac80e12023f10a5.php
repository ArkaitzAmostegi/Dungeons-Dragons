    ...
    <div class="page-partidas">
        <div class="card-partidas">
                    ...
                    <div class="tab-header">
                        ...
                        <div class="sub">
                            ...
                            <span class="js-tooltip" title="<?php echo e($campaign->juego->descripcion); ?>">
                                <span class="badge-role"><?php echo e(optional($campaign->juego)->nombre); ?></span>
                            </span>
                            <?php else: ?>
            ...
            <div style="margin:10px;">
                <a href="<?php echo e(route('añadirPartidas.index')); ?>" class="btn-new-partida"
...
<?php endif; ?><?php /**PATH /var/www/html/resources/views/partidas/index.blade.php ENDPATH**/ ?>